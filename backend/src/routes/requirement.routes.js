...
import { uploadOthers } from "../utils/upload.utils.js";
...
router.post("/upload-csv", authorize("BDE", "PM"), uploadOthers.single("file"), requirementController.uploadRequirements);
